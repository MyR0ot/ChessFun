 ...
 * @author My
 */
public class JFrameEndOfGame extends javax.swing.JFrame {

    private static String wName;
    private static String bName;
    private static ColorFigure winnerColor;
    ...
    public JFrameEndOfGame(String whiteName, String blackName, ColorFigure winnerColor, Game game) {
        ...
        switch(this.winnerColor)
        {
            case WHITE: jLabel1.setBackground(Color.WHITE); jLabel1.setText("<html><font size=\"6\">" + "Победитель: " + wName.toString() +"</font><br /></html>"); break;
            case BLACK: jLabel1.setBackground(Color.DARK_GRAY); jLabel1.setText("<html><font size=\"6\">" + "Победитель: " + bName.toString() +"</font><br /></html>"); break;
            default: jLabel1.setText("<html><font size=\"6\">" + "Ничья </font><br /></html>"); break;
        }
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEndOfGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEndOfGame(wName, bName, winnerColor, game).setVisible(true);
            }
        });
    }
